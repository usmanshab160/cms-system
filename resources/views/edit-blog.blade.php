 ...
 <!-- ─── MAIN ─── -->
  <main class="main">
    ...
    <div class="page-header">
      <div class="page-eyebrow"><span class="page-eyebrow-dot"></span> Update Blog Post</div>
            ...
            <div class="form-card-body">
              ...
              <div class="field">
                ...
                <div class="input-wrap">
                  ...
                  <input type="text" id="title" name="title" value="{{ old('title', $blog->title) }}" placeholder="e.g. 10 Tips for Better Content Strategy" maxlength="100"
              ...
              <div class="field">
                ...
                <div class="input-wrap" style="position:relative;">
                  <textarea id="description" name="description" placeholder="Briefly describe what this post is about…" maxlength="160" style="padding-left:14px;" oninput="updateCharCount('description','desc-count',160)">{{ old('description', $blog->description) }}</textarea>
                </div>
              ...
              <div class="row-2">
                <div class="field">
                  ...
                  <div class="input-wrap select-wrap">
                    ...
                    <select id="category" name="category">
                      ...
                      <option {{ old('category', $blog->category) == 'Technology' ? 'selected' : '' }}> Technology</option>
                      <option {{ old('category', $blog->category) == 'Marketing' ? 'selected' : '' }}> Marketing</option>
                      <option {{ old('category', $blog->category) == 'Design' ? 'selected' : '' }}> Design</option>
                      <option {{ old('category', $blog->category) == 'Business' ? 'selected' : '' }}> Business</option>
                      <option {{ old('category', $blog->category) == 'Tutorials' ? 'selected' : '' }}> Tutorials</option>
                      <option {{ old('category', $blog->category) == 'News' ? 'selected' : '' }}> News</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="input-wrap">
                    ...
                    <input type="text" id="read_time" name="read_time"  value="{{ old('read_time', $blog->read_time) }}" placeholder="5" style="padding-left:42px;" value="" readonly/>
                  </div>
                </div>
              </div>
              ...
              <div class="video-panel" id="vp-embed">
                <div class="field">
                  ...
                  <div class="input-wrap">
                    ...
                    <input type="url" id="video_url" name="video_url" value="{{ old('video_url', $blog->video_url) }}" placeholder="https://youtube.com/watch?v=…"/>
                  </div>
                </div>
              </div>
            ...
            <div class="form-card-body">
              ...
              <div class="field">
                ...
                <div class="input-wrap">
                  ...
                  <input type="text" id="meta_title" name="meta_title" value="{{ old('meta_title', $blog->meta_title) }}" placeholder="SEO-friendly title…" maxlength="70" oninput="updateSeo()"/>
                </div>
              </div>
              ...
              <div class="field">
                ...
                <div class="input-wrap">
                  <textarea id="meta_description" name="meta_description" placeholder="Brief summary shown in Google results…" maxlength="165" style="padding-left:14px;" oninput="updateSeo()">{{ old('meta_description', $blog->meta_description) }}</textarea>
                </div>
              </div>
              ...
              <div class="field">
                ...
                <div class="input-wrap">
                  ...
                  <input type="text" id="focus_keyword" name="focus_keyword" value="{{ old('focus_keyword', $blog->focus_keyword) }}" placeholder="e.g. content marketing strategy"/>
                </div>
              </div>
          ...
          <div class="publish-card">
            ...
            <div class="publish-card-body">
              ...
              {{-- <div class="field">
                ...
                <input type="hidden" name="status" id="statusInput" value="{{ old('status', $blog->status) }}"/>
              </div> --}}
<div class="field">
    <label>Status</label>
    ...
    class="status-opt {{ old('status', $blog->status) == 'draft' ? 'active' : '' }}"
    onclick="setStatus(this,'draft')">
    Draft
</button>

<button id="publishedBtn" type="button"
    class="status-opt {{ old('status', $blog->status) == 'published' ? 'active' : '' }}"
    onclick="setStatus(this,'published')">
    Published
</button>

<button id="scheduledBtn" type="button"
    class="status-opt {{ old('status', $blog->status) == 'scheduled' ? 'active' : '' }}"
    onclick="setStatus(this,'scheduled')">
    Scheduled
</button>
...
<input type="hidden"
    ...
    <input  id="statusInput" type="hidden"
           name="status"
           id="statusInput"
           value="{{ old('status', $blog->status) }}">
           </div>
              <div class="field" id="scheduledField" style="display:none;">
                ...
                <div class="input-wrap">
                  ...
                  <input type="datetime-local" id="scheduled_at" name="scheduled_at" value="{{ old('scheduled_at', optional($blog->scheduled_at)->format('Y-m-d\TH:i')) }}"/>
                </div>
              </div>
